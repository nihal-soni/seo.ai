        ...
        <div className="container mx-auto">
            <div className="border border-white/15 py-24 rounded-xl overflow-hidden relative" style={{ backgroundImage: `url(${starsBg.src})` }}>
                ...
                <div className="relative ">
                    ...
                    <p className="text-center text-lg md:text-xl max-w-xs mx-auto text-white/70 px-4 mt-5 tracking-tight">Achieve clear, impactful result without the complexity</p>
